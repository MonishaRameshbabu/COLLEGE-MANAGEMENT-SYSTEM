package com.placement.campus.controller;
...
public class StudentsController {
	...
	public String saveStudent(@ModelAttribute("student") Studentt student) {
	...
	public String updateStudent(@PathVariable Long id,
			@ModelAttribute("student") Studentt student,
			Model model) {
		
		// get student from database by id
		Studentt existingStudent = studentService.getStudentById(id);
